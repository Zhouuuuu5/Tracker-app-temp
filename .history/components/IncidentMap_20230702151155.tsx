...
const IncidentMap: React.FC<IncidentMapProps> = ({ data }) => {
  ...
  const handleBarPress = (label: string, value: number, event: any) => {
    setPopoverData({ label, value });
        ...
        >
          <TouchableOpacity>
            ...
            {popoverVisible && (
              ...
              >
                <View>
                  <Svg width={10} height={10} style={styles.triangle}>
                    <Polygon points={polygonPoints} fill="#283046" />
                  </Svg>
                </View>
